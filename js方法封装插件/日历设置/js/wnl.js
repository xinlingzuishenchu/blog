...
*/(function(e, t) {
	...
	t.prototype = {
		...
		getSubscriber: function(e) {
			...
			for (t, n; t < n; t++)
				if (this._subscribers[t].id === e || this._subscribers[t].fn === e) return this._subscribers[t]
		},
		...
		removeSubscriber: function(e) {
			...
			for (t; t >= 0; t--)
				if (this._subscribers[t].fn === e || this._subscribers[t].id === e) this._subscribers[t].channel = null, this._subscribers.splice(t, 1)
		},
		publish: function(e) {
			var t = 0,
				n = this._subscribers.length,
		...
		getChannel: function(e) {
			...
			if (e === "") return t;
			if (n.length > 0)
				for (r, i; r < i; r++) t.hasChannel(n[r]) || t.addChannel(n[r]), t = t.returnChannel(n[r]);
			return t
		},
...
(function() {
	...
	function h(e) {
		var t = -0.043126 + 628.301955 * e - 2732e-9 * e * e,
			n = .016708634 - 42037e-9 * e - 1.267e-7 * e * e;
	...
	function g(e) {
		...
		var o, u = l;
		for (o = 0; o < u.length; o += 5)
			if (e < u[o + 5]) break;
		var a = (e - u[o]) / (u[o + 5] - u[o]) * 10,
			f = a * a,
			c = f * a;
	...
	var e = {
		...
		i = {
			...
			cache: {},
			getTerms: function(t) {
				var n = i.getNearestWinter(t),
					r = [];
				if (i.cache[n]) r = i.cache[n];
				else {
					r.hash = {};
		...
		s = {
			...
			fromDate: function(e) {
				var t = e.getFullYear(),
					n = e.getMonth() + 1,
					r = e.getDate() + ((e.getSeconds() / 60 + e.getMinutes()) / 60 + e.getHours()) / 24,
					i = t * 372 + n * 31 + Math.floor(r) >= 588829,
					s = 0;
				return n <= 2 && (n += 12, t -= 1), i && (s = Math.floor(t / 100), s = 2 - s + Math.floor(s / 4)), Math.floor(365.25 * (t + 4716)) + Math.floor(30.6001 * (n + 1)) + r + s - 1524.5
			}
		},
		o = [-0.08631, 39e-5, -0.00008, -0.07447, 6e-5, 17e-5, -0.07135, -0.00026, -0.00176, -0.20239, .00273, -0.00347, -0.25486, .00276, .42926, .24588, .00345, -14.46266, -0.95116, .02481, 58.30651],
		...
		a = [
			[
				...
				[12e-6, 1.041, -2.3012, 1.52, 25, -0.1, 17e-7, .31, -0.711, 0, 0, 0]
			]
		],
		f = 648e3 / Math.PI,
		l = new Array(-4e3, 108371.7, -13036.8, 392, 0, -500, 17201, -627.82, 16.17, -0.3413, -150, 12200.6, -346.41, 5.403, -0.1593, 150, 9113.8, -328.13, -1.647, .0377, 500, 5707.5, -391.41, .915, .3145, 900, 2203.4, -283.45, 13.034, -0.1778, 1300, 490.1, -57.35, 2.085, -0.0072, 1600, 120, -9.81, -1.532, .1403, 1700, 10.2, -0.91, .51, -0.037, 1800, 13.4, -0.72, .202, -0.0193, 1830, 7.8, -1.81, .416, -0.0247, 1860, 8.3, -0.13, -0.406, .0292, 1880, -5.4, .32, -0.183, .0173, 1900, -2.3, 2.06, .169, -0.0135, 1920, 21.2, 1.69, -0.304, .0167, 1940, 24.2, 1.22, -0.064, .0031, 1960, 33.2, .51, .231, -0.0109, 1980, 51, 1.29, -0.026, .0032, 2e3, 63.87, .1, 0, 0, 2005, 64.7, .4, 0, 0, 2015, 69),
		c = new Array(2.1824, -33.75705, 36e-6, -1720, 920, 3.5069, 1256.66393, 11e-6, -132, 57, 1.3375, 16799.4182, -0.000051, -23, 10, 4.3649, -67.5141, 72e-6, 21, -9, .04, -628.302, 0, -14, 0, 2.36, 8328.691, 0, 7, 0, 3.46, 1884.966, 0, -5, 2, 5.44, 16833.175, 0, -4, 2, 3.69, 25128.11, 0, -3, 0, 3.55, 628.362, 0, 2, 0),
		w = {
			E_Lon: function(e, t) {
				return y(0, 0, e, t)
			},
	...
	var S = window.OB.RiLi.dateAllFestival,
		x = {};
	x.w = {}, $.each(S, function(e, t) {
		...
		var e = this.oDate.getFullYear(),
			t = this.oDate.getMonth() + 1,
			n = this.oDate.getDate(),
			r = T(t) + T(n),
			i = this.oDate.getDay(),
			s = Math.ceil(n / 7),
			o = T(t) + s + i,
				...
				methods: {
					...
					clear: function(e) {
						if (!e) localStorage.clear();
							...
							for (var t = localStorage.length - 1, n; n = localStorage.key(t--);) n && n.indexOf(e) === 0 && localStorage.removeItem(n)
					}
				}
			}, e.userData = {
				test: function() {
...
(function() {
	...
	var e = "http://hao.360.cn/time.php",
		t = 6e4,
		n = 3e5;
...
(function() {
	var e = window.OB.RiLi,
		t = e.useLunarTicketDay,
		n = e.lunar,
		r = e.dateHuochepiao,
		i = [],
		s = {},
		...
		u = "<span class='mh-ticket {cls}'>\u7968{monthday}</span>",
		a = "<span class='red'>\u53ef\u9884\u8ba2{month}\u6708{day}\u65e5\u8f66\u7968</span>",
		f = "<em class='mh-lunar-ticket'>\u519c\u5386{l}</em>",
		l = function(e, t) {
			var n = e.substr(0, 4),
				r = e.substr(4, 2),
				i = e.substr(6, 2),
				s = new Date([n, r, i].join("/"));
			t != 0 && (s = t < 0 ? new Date(+s - 864e5) : new Date(+s + 864e5));
			var u = o(s.getMonth() + 1),
				a = o(s.getDate());
	...
	for (var c = 0; c < r.length; ++c) {
		...
		if (/^-\d{8}$/.test(lineInfo[0])) {
			i.push({
				date: l(lineInfo[0].substr(1, 8), -1),
				delta: lineInfo[1],
				cmd: "<"
			});
			continue
	...
	e.Huochepiao = {
		...
		getHuochepiaoDayHtml: function(n, r, i) {
			var s = this.getHuochepiaoDay(n, r, i),
				a = s["color"] == "red" ? "mh-hotticket" : "",
				f = o(s.piaodate.getMonth() + 1),
				l = o(s.piaodate.getDate()),
				c = [n, o(r), o(i)].join("/"),
				h = [e.today.getFullYear(), o(e.today.getMonth() + 1), o(e.today.getDate())].join("/"),
				p = s.piaodate.getFullYear();
			if (c >= h) {
				var d = [f, l].join(""),
					v = t[p] && t[p][d] ? " " + t[p][d] : f + "." + l;
				return $.format(u, {
					cls: a,
					monthday: v
				})
		...
		getHuochepiaoDayGongli: function(e, t, n) {
			...
			return $.format(a, {
				month: o(r.piaodate.getMonth() + 1),
				day: o(r.piaodate.getDate())
			})
		},
		getHuochepiaoDayGongliProxy: function(e, t, n) {
			var r = this.getHuochepiaoDay(e, t, n),
				i = new Date(r.piaodate - 1728e5);
			return $.format(a, {
				month: o(i.getMonth() + 1),
				day: o(i.getDate())
			})
		},
		getHuochepiaoDayNongli: function(e, t, r) {
			var i = this.getHuochepiaoDay(e, t, r),
				s = n(i.piaodate),
				o = s.lMonth.replace("\u5341\u4e8c", "\u814a") + "\u6708" + s.lDate;
			return $.format(f, {
				l: o
			})
		},
		getHuochepiaoDayNongliProxy: function(e, t, r) {
			var i = this.getHuochepiaoDay(e, t, r),
				s = new Date(i.piaodate - 1728e5),
				o = n(s),
				u = o.lMonth + "\u6708" + o.lDate;
			return $.format(f, {
				l: u
			})
		}
	...
	$.widget("rili.fakeSelect", {
		...
		_create: function() {
			...
			this.name = n.name, this.prev = t.find(".mh-prev"), this.next = t.find(".mh-next"), this.cont = t.find("div.mh-control"), this.header = t.find(".mh-field"), this.list = t.find(".mh-list"), this.cont.find(".mh-holiday").length > 0 ? this.list.html($.format('<li val="{value}" is_sel={is_sel}>{text}</li>', n.data)) : this.list.html($.format('<li val="{value}">{text}</li>', n.data)), this.opts = this.list.find("li"), this.cont.click(function() {
				...
				if (e.list.is(":visible")) {
					var t = e.header.attr("val") || "",
						n = e.opts.removeClass("mh-on").filter('[val="' + t + '"]').addClass("mh-on");
					n.size() && e.list.scrollTop(n.prop("offsetTop") - 42)
				}
			}), this.opts.mouseenter(function() {}).click(function(t) {
				e.list.hide();
				var r = $(this).addClass("mh-on"),
					i = r.attr("val"),
					s = r.text(),
					o = e.header.attr("val");
		...
		setValue: function(e) {
			var t = this,
				...
				r = this.options,
				i = this.hasValue(e);
			if (i) this.header.attr("val", e).text(i.text());
			else {
	...
	$.padWithZero = function(e) {
		...
		initTime: function(n) {
			var s = this,
				...
				u = o.getFullYear(),
				a = o.getMonth() + 1;
			this.now = new Date, this.today = e.today, this.initCalendar(u, a), this.options.onselect.call(s, o, i(o)), this._showCurrentTime(), r.publish(t.type.ctc, {
				data: o
			})
		},
		initCalendar: function(s, o, a) {
			var l = this,
				c = $(this.element),
				h = this.options,
				p = new Date(s, o - 1, a || 1),
				d = new window.OB.RiLi.Calendar(p),
				v = d.getCalendarFirstDate(),
				m = this.today;
			...
			var S = new Date(v),
				x = $.map(new Array(42), function(s, a) {
					var c = S.getFullYear(),
						h = S.getMonth(),
						p = S.getDate(),
						d = S.getDay(),
					...
					return C = T[0] && T[0].desc.length < 9 && T[0].desc || v.term || v.dateIndex == 0 && v.lMonth + "\u6708" + (v.isBigMonth ? "\u5927" : "\u5c0f") || v.lDate, C.length > 4 ? $.format(N, {
						...
						solar: p,
						lunar: C,
						date: [c, h + 1 < 10 ? ("0" + (h + 1)) : h + 1, p < 10 ? "0" + p : p].join("/"),
						goupiao: goupiao,
						lunarTitle: "title='" + C + "'"
					}) : $.format(N, {
						monthClass: w.join(" "),
		...
		handleClick: function() {
			...
			$(n.panel).delegate("li", "click", function() {
				$(this).hasClass("mh-on") ? $(this).removeClass("mh-on") : $(this).addClass("mh-on"), n.panel.find("li.reston").removeClass("reston").addClass("mh-rest"), n.panel.find("li.workon").removeClass("workon").addClass("mh-work");
				var s = $(this).addClass(""),
					u = s.attr("date"),
					a = new Date(u),
					f = a.getFullYear(),
				...
				r.publish(t.type.fhv, {
					data: f,
					from: n.dltYear
				}), c = t.returnValue, l == n.month && f == n.year || !c ? (o.onselect.call(n, a, i(a)), r.publish(t.type.ctc, {
					data: a
				}), typeof e.CallBack.holiday == "function" && e.CallBack.holiday($.trim(n.panel.find('li[date="' + u + '"]').find(".mh-lunar").html()), n.year)) : (r.publish(t.type.fsv, {
					data: f,
					from: n.dltYear
				}), r.publish(t.type.fsv, {
					data: l,
					from: n.dltMonth
				}), r.publish(t.type.ftc, {
					data: {},
					from: n.dltMonth
		...
		initDatePicker: function() {
			...
			h = h > 9 ? h : "0" + h + "", $.each(a, function(e, t) {
				...
				e.preventDefault(), r.publish(t.type.fsv, {
					...
					data: {},
					from: n.dltMonth
				}), n.panel.find("li.mh-today").click()
			})
		}
	})
})();
(function() {
	var e = {
			getAstroByDate: function(e, t) {
				var n = "\u9b54\u7faf\u6c34\u74f6\u53cc\u9c7c\u7261\u7f8a\u91d1\u725b\u53cc\u5b50\u5de8\u87f9\u72ee\u5b50\u5904\u5973\u5929\u79e4\u5929\u874e\u5c04\u624b\u9b54\u7faf",
	...
	$.widget("rili.dayDetail", {
		...
		loadLuckyData: function(e, t, n) {
			var r = this,
				i = $(this.element),
				s = this.options,
				o = "d" + ("0" + t).slice(-2) + ("0" + n).slice(-2),
				u = window.OB.RiLi.HuangLi;
		...
		fillLuckyData: function(e) {
			...
			var n = this,
				r = $(this.element),
				i = this.options,
				s = e.y.replace(/^\.|\.$/g, "").split("."),
				o = e.j.replace(/^\.|\.$/g, "").split(".");
			$(".mh-suited .mh-st-items").html(t(s)).attr("title", s.join(" ")), $(".mh-tapu .mh-st-items").html(t(o)).attr("title", o.join(" "))
		}
	})
})();
(function() {
	var e = window.OB.RiLi.mediator,
		t = window.OB.RiLi.msg_config,
		n = $(".mh-calendar");
...
(function() {
	var e = window.OB.RiLi.msg_config,
		t = window.OB.RiLi.mediator,
		n = function() {
			var e = {},
				t = $("#mh-rili-params").val() || "";
			if (t) {
